...
export function AnthropicLogo({ className = "" }: LogoProps) {
  return (
    <svg viewBox="0 0 91 91" className={className} aria-label="Anthropic">
      <defs>
...
export function MistralLogo({ className = "" }: LogoProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-label="Mistral">
...
export function GroqLogo({ className = "" }: LogoProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-label="Groq">
...
export function OllamaLogo({ className = "" }: LogoProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-label="Ollama">
