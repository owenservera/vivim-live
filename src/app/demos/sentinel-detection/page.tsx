        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            <div className="p-6 rounded-2xl glass-card">
                ...
                {ALGORITHMS.slice(0, 8).map((algo) => (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-xs text-slate-400 font-mono">A{ALGORITHMS.indexOf(algo) + 1}</span>
                    </div>
                    <p className="text-xs text-slate-300 leading-tight truncate">{algo.name.split(" ")[0]}</p>
                  </div>
                ))}
              </div>
              ...
              >
                {isScanning ? "Scanning..." : "Start Detection Scan"}
              </button>
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-sm text-red-400 font-medium">
                      {detectionResults.length} Detection{detectionResults.length > 1 ? "s" : ""} Found
                    </span>
                  </div>
