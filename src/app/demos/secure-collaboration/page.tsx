...
import { SecureCollaborationDemo } from "@/components/secure-collaboration-demo";
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 pb-20">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-emerald-500/30 mb-6">
            ...
            <span className="text-sm text-slate-300">Secure Collaboration Demo</span>
          </div>
        ...
        <div className="max-w-3xl mx-auto">
          <SecureCollaborationDemo />
        </div>

        <div className="mt-12 text-center">
          <p className="text-sm text-slate-500 mb-6">
            Want to see how your data is protected? Try the{" "}
            <Link href="/demos/zero-knowledge-privacy" className="text-emerald-400 hover:text-emerald-300">
